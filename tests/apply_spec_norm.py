...
if 1:
    main_path = Path("/home/amiguel/seminar/data_files/ESPRESSO/proxima")
    file_start = "r.ESPRE.2019-09-25T23:19:55.406_S2D_A.fits"
...
d = ESPRESSO(main_path / file_start, user_configs={"NORMALIZE_SPECTRA": True,
                                                   "NORMALIZATION_MODE": "Derivative",
                                                   "apply_FluxBalance_Norm":True,
                                                   "apply_FluxCorr":True
                                                   }
             )
