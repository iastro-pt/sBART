...
def test_Model_component_init():
    flag_1 = Flag(
        name="teste", value="A", description="teste flag", fatal_flag=True, is_warning=False, is_good_flag=False
    )
    ...
    flag_1 = Flag(
        name="teste", value="A", description="teste flag", fatal_flag=False, is_warning=False, is_good_flag=True
    )
