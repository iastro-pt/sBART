...
def compute_DLW(spec_wave, spec_flux, spec_variance, temp_flux, temp_variance):
    ...
    sigma_A = np.sum(squared_weights * squared_derivative * squared_residuals * (
...
if __name__ == "__main__":
    ...
    for d_sigma in np.linspace(-0.5, 0.5, 50):
        ...
        dlw, err = compute_DLW(spec, spec_flux=gauss,
        ...
        axis.errorbar(100*d_sigma / sigma, 100 * (dlw - injected) / injected, err, color="black", marker='x', ls='')
